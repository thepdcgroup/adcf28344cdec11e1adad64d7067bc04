...
###Set page variables
$page_title = $site_name . ' - Navigation';
###Create page css
$page_css = <<<HEREDOC
<link rel="stylesheet" href="{$address}assets/navigation.css">
HEREDOC;
###Get file data
require_once $location . '/dependencies/ritchey_get_content_from_value_tag_i1_v1/ritchey_get_content_from_value_tag_i1_v1.php';
$data = ritchey_get_content_from_value_tag_i1_v1("{$location}/content_files/pages/navigation.html.txt", 1, TRUE, TRUE);
...
##Write file
@file_put_contents("{$location}{$public_folder}/navigation.html", $data);
##</value>
?>