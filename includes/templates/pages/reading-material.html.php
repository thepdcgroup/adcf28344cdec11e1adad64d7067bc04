...
###Create page css
$page_css = <<<HEREDOC
<link rel="stylesheet" href="{$address}assets/reading-material.css">
HEREDOC;
###Get file data
require_once $location . '/dependencies/ritchey_get_content_from_value_tag_i1_v1/ritchey_get_content_from_value_tag_i1_v1.php';
$data = ritchey_get_content_from_value_tag_i1_v1("{$location}/content_files/pages/reading-material.html.txt", 1, TRUE, TRUE);
...
<div class='section_outter' id='content_section_outter'>
	...
	<div class='outter_h2'><div class='inner_h2'>Reading Material</div></div>
		{$data}
	</div>
</div>
HEREDOC;
...
##Write file
@file_put_contents("{$location}{$public_folder}/pages/reading-material.html", $data);
##</value>
?>