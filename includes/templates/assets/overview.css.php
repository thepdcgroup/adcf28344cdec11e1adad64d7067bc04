...
$data = ritchey_get_content_from_value_tag_i1_v1("{$location}/content_files/assets/overview.css.txt", 1, TRUE, TRUE);
##Write file
...
if (@file_exists("{$location}{$public_folder}/assets/overview.css") === TRUE){
	unlink("{$location}{$public_folder}/assets/overview.css");
}
@file_put_contents("{$location}{$public_folder}/assets/overview.css", $data, FILE_APPEND | LOCK_EX);
##</value>
?>