...
$data = ritchey_get_content_from_value_tag_i1_v1("{$location}/content_files/assets/evaluation.css.txt", 1, TRUE, TRUE);
##Write file
...
if (@file_exists("{$location}{$public_folder}/assets/evaluation.css") === TRUE){
	unlink("{$location}{$public_folder}/assets/evaluation.css");
}
@file_put_contents("{$location}{$public_folder}/assets/evaluation.css", $data, FILE_APPEND | LOCK_EX);
##</value>
?>